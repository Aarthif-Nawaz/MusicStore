...
public class TableView {
    public TableView(String itemType, int itemID, String title, String genre, String songDuration, String speed, String diametre, LocalDate releaseDate, String artist, Double price, Integer spceleft, LocalDate sellingDate, LocalTime sellingTime) {
        ItemType = itemType;
        ItemID = itemID;
        Title = title;
        Genre = genre;
